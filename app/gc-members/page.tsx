    ...
    return (
        <main className=" min-h-screen bg-black relative overflow-x-hidden">
            ...
            <section className='flex flex-col justify-center absolute w-screen min-h-screen pt-10 lg:pt-0 pb-56 xl:pb-40'>
                <h1 className={lilita.className + ' text-6xl md:text-7xl text-center lg:text-8xl text-white font-black pt-10 lg:pt-0 pb-10 uppercase'}>GC Members</h1>
                <div className={mont.className + ' md:grid md:grid-cols-2 lg:grid-cols-3 gap-x-5 px-10 lg:px-32 xl:px-40 gap-y-5 flex flex-col gap-5'}>
                    {gc_members.map((member,key)=>(
                        <div className=' bg-bggray p-5 rounded-xl flex justify-between w-full items-center'>
                            <div className=''>
                                ...
                                <p className='text-textgreen font-light lg:text-xl'>{member.position}</p>
                            </div>
