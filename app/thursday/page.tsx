...
const Thursday = () => {
    ...
    //       <div className='flex flex-col gap-2 text-base md:text-xl font-medium text-center'>{data[3].L.map((menuitem, key) => (
    //         <h1 key={key}>{menuitem}</h1>
    //       ))}</div>
    //     </div>
    //     <div className=' flex flex-col justify-start items-center p-10 border-4 border-textgreen/50 text-white rounded-xl'>
    //       <h1 className='text-4xl md:text-5xl pb-5 font-extrabold text-textgreen'>Dinner</h1>
    //       <div className='flex flex-col gap-2 text-base md:text-xl font-medium text-center'>{data[3].D.map((menuitem, key) => (
    //         <h1 key={key}>{menuitem}</h1>
    //       ))}</div>
    //     </div>
    //   </div>
