...
const Friday = () => {
    ...
    //       <h1 className={pacifico.className + " text-6xl md:text-7xl text-center lg:text-8xl text-white font-black pt-10"}>{data[4].Day}</h1>
    //       <div className='pb-10'>
    //         <h1 className='text-3xl font-medium text-gray-400 pt-2'>{data[4].Date}</h1>
    //       </div>
    ...
    //               <h1 key={i} className='text-center text-base md:text-xl font-medium'>{breakfast}</h1>
    //             ))}
    //           </div>
    //           <div className='flex flex-col gap-2 text-base md:text-xl font-medium text-center'>{data[4].B.map((menuitem, key) => (
    ...
    //           <div className='flex flex-col gap-2 text-base md:text-xl font-medium text-center'>{data[4].L.map((menuitem, key) => (
    //             <h1 key={key}>{menuitem}</h1>
    //           ))}</div>
    //         </div>
    //         <div className=' flex flex-col justify-start items-center p-10 border-4 border-textgreen/50 text-white rounded-xl'>
    //           <h1 className='text-4xl md:text-5xl pb-5 font-extrabold text-textgreen'>Dinner</h1>
    //           <div className='flex flex-col gap-2 text-base md:text-xl font-medium text-center'>{data[4].D.map((menuitem, key) => (
    //             <h1 key={key}>{menuitem}</h1>
    //           ))}</div>
    //         </div>
    //       </div>
